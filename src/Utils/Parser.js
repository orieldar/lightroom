...
var kindesHandler = function (kind, lectures, groupId, session, teacherName) {
    switch (kind) {
        case "תרגיל":
            var practice = exports.makePractice(teacherName, groupId, [session]);
            if (lectures[lectures.length - 1] !== undefined)
                lectures[lectures.length - 1].practices.push(practice);
            else
                lectures.push(exports.makeLecture(groupId, teacherName, [], [practice]));
            break;
        case "שעור":
